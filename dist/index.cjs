var $6fEQP$metavatemaidpcoinrpc = require("@metavatem/aidpcoin-rpc");
var $6fEQP$metavatemaidpcoinkey = require("@metavatem/aidpcoin-key");
var $6fEQP$metavatemaidpcoinsigntransaction = require("@metavatem/aidpcoin-sign-transaction");
...
$parcel$export(module.exports, "Wallet", () => $74458cdd21b69d3a$export$bcca3ea514774656);
$parcel$export(module.exports, "default", () => $74458cdd21b69d3a$export$2e2bcd8739ae039);
$parcel$export(module.exports, "createInstance", () => $74458cdd21b69d3a$export$99152e8d49ca4e7d);
...
(0, ($parcel$interopDefault($6fEQP$metavatemaidpcoinsigntransaction))).sign; //"Idiocracy" but prevents bundle tools such as PARCEL to strip this dependency out on build.
...
async function $fdd8716063277f2b$export$322a62cff28f560a(WIF, wallet, onlineMode) {
    const privateKey = (0, ($parcel$interopDefault($6fEQP$metavatemaidpcoinkey))).getAddressByWIF(wallet.network, WIF);
    const result = {};
    ...
    const signedHex = (0, ($parcel$interopDefault($6fEQP$metavatemaidpcoinsigntransaction))).sign(wallet.network, rawHex, UTXOs, privateKeys);
...
async function $9b3ed6549b57daad$export$df96cd8d56be0ab1(wallet, addresses) {
    ...
    const balance = await wallet.rpc((0, $6fEQP$metavatemaidpcoinrpc.methods).getaddressbalance, params);
...
const $74458cdd21b69d3a$var$URL_AIDPCOIN_MAINNET = "https://aidp-rpc-mainnet.ting.finance/rpc";
const $74458cdd21b69d3a$var$URL_AIDPCOIN_TESTNET = "https://aidp-rpc-testnet.ting.finance/rpc";
const $74458cdd21b69d3a$var$URL_EVRMORE_MAINNET = "https://evr-rpc-mainnet.ting.finance/rpc";
class $74458cdd21b69d3a$export$bcca3ea514774656 {
   ...
   *
   * NOTE: the address you sweep needs to cointain enough AIDP to pay for the transaction
   *
   ...
   */ sweep(WIF, onlineMode) {
    ...
    async init(options) {
        ...
        let url = $74458cdd21b69d3a$var$URL_AIDPCOIN_MAINNET;
        //VALIDATION
        ...
        if (options.network === "aidp-test") url = $74458cdd21b69d3a$var$URL_AIDPCOIN_TESTNET;
        if (options.network === "evr") url = $74458cdd21b69d3a$var$URL_EVRMORE_MAINNET;
        ...
        this.rpc = (0, $6fEQP$metavatemaidpcoinrpc.getRPC)(username, password, url);
        this._mnemonic = options.mnemonic;
        //Generating the hd key is slow, so we re-use the object
        const hdKey = (0, ($parcel$interopDefault($6fEQP$metavatemaidpcoinkey))).getHDKey(this.network, this._mnemonic);
        const coinType = (0, ($parcel$interopDefault($6fEQP$metavatemaidpcoinkey))).getCoinType(this.network);
        const ACCOUNT = 0;
        ...
        while(doneDerivingAddresses === false){
            ...
            const tempAddresses = [];
            for(let i = 0; i < 20; i++){
                const external = (0, ($parcel$interopDefault($6fEQP$metavatemaidpcoinkey))).getAddressByPath(this.network, hdKey, `m/44'/${coinType}'/${ACCOUNT}'/0/${this.addressPosition}`);
                const internal = (0, ($parcel$interopDefault($6fEQP$metavatemaidpcoinkey))).getAddressByPath(this.network, hdKey, `m/44'/${coinType}'/${ACCOUNT}'/1/${this.addressPosition}`);
    ...
    async hasHistory(addresses) {
        ...
        const asdf = await this.rpc((0, $6fEQP$metavatemaidpcoinrpc.methods).getaddressbalance, [
            obj,
            includeAssets
        ]);
        //@ts-ignore
    ...
    async getHistory() {
        ...
        const deltas = this.rpc((0, $6fEQP$metavatemaidpcoinrpc.methods).getaddressdeltas, [
            {
                addresses: addresses,
                assetName: assetName
            }
    ...
    async getMempool() {
        const method = (0, $6fEQP$metavatemaidpcoinrpc.methods).getaddressmempool;
        const includeAssets = true;
        const params = [
            {
   ...
   */ async getAssetUTXOs(assetName) {
        ...
        return this.rpc((0, $6fEQP$metavatemaidpcoinrpc.methods).getaddressutxos, params);
    }
    async getUTXOs() {
        return this.rpc((0, $6fEQP$metavatemaidpcoinrpc.methods).getaddressutxos, [
            {
                addresses: this.getAddresses()
            }
        ]);
   ...
   */ async createTransaction(options) {
        ...
        const signed = (0, ($parcel$interopDefault($6fEQP$metavatemaidpcoinsigntransaction))).sign(this.network, raw, transaction.getUTXOs(), privateKeys);
        try {
            ...
            const sendResult = {
                ...
                debug: {
                    ...
                    aidpChangeAmount: transaction.getBaseCurrencyChange(),
                    aidpAmount: transaction.getBaseCurrencyAmount(),
   ...
   */ async getUTXOsInMempool(mempool) {
    ...
    constructor(){
        this.rpc = (0, $6fEQP$metavatemaidpcoinrpc.getRPC)("anonymous", "anonymous", $74458cdd21b69d3a$var$URL_AIDPCOIN_MAINNET);
        this._mnemonic = "";
        this.network = "aidp";
        this.addressObjects = [];
        this.receiveAddress = "";
        ...
        this.baseCurrency = "AIDP" //Default is AIDP but it could be EVR
        ;
        this.offlineMode = false;
    }
}
var $74458cdd21b69d3a$export$2e2bcd8739ae039 = {
    createInstance: $74458cdd21b69d3a$export$99152e8d49ca4e7d,
    getBaseCurrencyByNetwork: $e42f6e77e719937d$export$af0c167f1aa2328f
};
async function $74458cdd21b69d3a$export$99152e8d49ca4e7d(options) {
    const wallet = new $74458cdd21b69d3a$export$bcca3ea514774656();
