import AidpcoinKey, { Network } from "@metavatem/aidpcoin-key";
import Signer from "@metavatem/aidpcoin-sign-transaction";
...
export async function sweep(
  ...
  const privateKey = AidpcoinKey.getAddressByWIF(wallet.network, WIF);
